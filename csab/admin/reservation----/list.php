...
?>
  <tr class="<?php echo $class; ?>"> 
   <td width="75" align="center"><?php echo $cat_name; ?></td>
   <td><?php echo $pd_name; ?> ( <?php echo $pd_code; ?> )</h3></td>

   <td width="70" align="center"><a href="index.php?view=reserve&productId=<?php echo $pd_id; ?>" >Reserve</a></td>
